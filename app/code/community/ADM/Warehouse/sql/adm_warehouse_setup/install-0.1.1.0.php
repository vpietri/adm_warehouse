...
/**
 * Create table 'adm_warehouse/sales_item_quote'
 */
$table = $installer->getConnection()
...
->addIndex($installer->getIdxName('adm_warehouse/sales_item_quote', array('quote_item_id', 'stock_id')),array('quote_item_id', 'stock_id'))
->addForeignKey($installer->getFkName('adm_warehouse/sales_item_quote', 'quote_item_id', 'sales/quote_item', 'item_id'),
...
/**
 * Create table 'adm_warehouse/sales_item_creditmemo'
 */
$table = $installer->getConnection()
...
->addIndex($installer->getIdxName('adm_warehouse/sales_item_creditmemo', array('creditmemo_item_id', 'stock_id')),array('creditmemo_item_id', 'stock_id'))
->addForeignKey($installer->getFkName('adm_warehouse/sales_item_creditmemo', 'creditmemo_item_id', 'sales/creditmemo_item', 'entity_id'),
